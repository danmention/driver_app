          ...
          child: Padding(
            ...
            child: Column(
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      ...
                      style: TextStyle(
                        color: Colors.white,
                          fontSize: 50, fontFamily: 'Brand Bold'
                      ),
                ...
                //Text("\NGN${Provider.of<AppData>(context, listen: false).earnings}", style: TextStyle(color: Colors.white, fontSize: 50, fontFamily: 'Brand Bold'),)
              ],
            ),
          ),
        ),
