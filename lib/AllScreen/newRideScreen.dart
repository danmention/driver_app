...
//currentlatlng-- is the current position of driver while the pickuplatlng is the loction of the rider where the driver is going to pick him up
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () async
                        {
                          if(status == "accepted")
                          {
                            ...
                            // take note 99--- not needed in massage
  ...
  //this code is what updates from picup to dstination not needed for massage
